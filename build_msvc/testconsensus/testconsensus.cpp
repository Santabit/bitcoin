...
// santabit includes.
#include <..\src\script\santabitconsensus.h>
...
int main()
{
    std::cout << "santabitconsensus version: " << santabitconsensus_version() << std::endl;
   ...
   santabitconsensus_error err;
    auto op0Result = santabitconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, santabitconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
